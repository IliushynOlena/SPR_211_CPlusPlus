...
#pragma region Work with Product
struct Product
{
	char name[20];//20
	double price;//8
...
//	fileIn >> symbol;		// цей варіант ігнорує всі пробільні символи (пробіл, 
...
//{
//	fileIn >> str;			// зчитує до першого пробільного символа
//							// пробільні символи також відкидаються
//	
//	cout << str << endl;	// вивід cлів з нового рядка
//}
